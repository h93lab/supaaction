...
- تشفير التوكنات داخل SQLite باستخدام AES-256-GCM، ورفض `ENCRYPTION_KEY` أو `SESSION_SECRET` الأقصر من 32 حرفًا في الإنتاج.
- جلسة إدارة محمية بكلمة مرور وCookie من نوع `HttpOnly`، مع تغيير كلمة المرور من الواجهة وإلغاء كل الجلسات القديمة.
- حماية CSRF وSecurity Headers وRate Limit دائم داخل SQLite، محسوبًا لكل عنوان IP مع سقف عام، حتى لا تُقفل أنت خارج لوحتك بمحاولات غريب.
